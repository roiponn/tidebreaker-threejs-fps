...
export class MobileControls {
  ...
  constructor(container: HTMLElement, private readonly input: Input) {
    ...
    this.bindMovement();
    this.bindLook();
    this.bindHeldButton('.mobile-action-fire', (down) => this.input.setVirtualFire(down));
    this.bindHeldButton('.mobile-action-aim', (down) => this.input.setVirtualAim(down));
  ...
  private bindHeldButton(selector: string, setDown: (down: boolean) => void): void {
